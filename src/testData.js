...
export const cities = [
    ...
    // new City("Kijów", 50.4501, 30.5234),
    // new City("Warszawa", 52.229676, 21.012229),
    // new City("Mediolan", 45.464204, 9.189982),
    ...
    // new City("Kluczbork", 50.97235, 18.2180699),
    // new City("Opole", 50.6751067, 17.9212976),
    // new City("Trzebnica", 51.3104211, 17.0632716),
    // new City("Środa Śląska", 51.1641896, 16.5925834),
    // new City("Strzelce Opolskie", 50.51092, 18.29987),
